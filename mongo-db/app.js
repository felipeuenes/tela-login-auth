...
app.get('/', (req, res) => {
    res.status(200).json({msg: "bem vindo, deu certo!"})
})
...
mongoose.connect(`mongodb+srv://${dbUser}:${dbPassword}@cluster0.pkd1ibt.mongodb.net/?retryWrites=true&w=majority`).then(
    app.listen(3000),
